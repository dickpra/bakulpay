                  ...
                  children: [
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: Text(style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,),'+Rp.33.798,00'),
                      ),
                    ),
                    Align(
                      alignment: Alignment.center,
                      child: Padding(
                        padding: EdgeInsets.all(0),
                        child: Text(style: TextStyle(fontSize: 18,fontWeight: FontWeight.normal,color: Colors.orange),'Status'),
                      ),
                    ),
                    Align(
                      alignment: Alignment.center,
                      child: Padding(
                        padding: EdgeInsets.all(0),
                        child: Text(style: TextStyle(fontSize: 15,fontWeight: FontWeight.normal,),'27 October 2023 14:20 PM'),
                      ),
                    ),
                  ],
                ),
