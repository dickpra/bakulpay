          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                Form(key: _formKey,child: textForm(namaPengirim, 'Masukkan Nama Pengirim / Tx Hash', [FilteringTextInputFormatter.deny(RegExp(' '))], TextInputType.text, 'Masukkan Nama Pengirim', '', false)),
                SizedBox(height: 20),
                Align(
                  alignment: Alignment.topLeft,
                  child: Padding(
